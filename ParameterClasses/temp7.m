classdef temp7  
    properties
        ...
        processing_intermediates = 'Projects\Cortical Dynamics\Cortical Neuropixel Widefield Dynamics\Analysis\MotifDiscoveryParams\L23\'; %location of the intermediate files in the processing pipeline
