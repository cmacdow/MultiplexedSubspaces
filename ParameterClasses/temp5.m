classdef temp5  
    properties
        ...
        processing_intermediates = 'Projects\Cortical Dynamics\Cortical Neuropixel Widefield Dynamics\Analysis\MotifDiscoveryParams\L10\'; %location of the intermediate files in the processing pipeline
