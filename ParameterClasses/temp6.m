classdef temp6  
    properties
        ...
        processing_intermediates = 'Projects\Cortical Dynamics\Cortical Neuropixel Widefield Dynamics\Analysis\MotifDiscoveryParams\L15\'; %location of the intermediate files in the processing pipeline
